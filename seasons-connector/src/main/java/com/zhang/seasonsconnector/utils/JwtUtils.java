package com.zhang.seasonsconnector.utils;

import com.zhang.seasonsconnector.config.SeasonsAuthenticationToken;
...
public class JwtUtils {
    ...
    public static SeasonsAuthenticationToken validateToken(String token) {
        try {
            ...
            List<SimpleGrantedAuthority> authorities = SeasonsUserDetailsService.getAuths(body.get("authorities").toString());

            return new SeasonsAuthenticationToken(id, type, principal, "", authorities);
